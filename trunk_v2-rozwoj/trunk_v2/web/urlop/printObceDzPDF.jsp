...
%><%//
			...
			response.setHeader( "Content-disposition" , "attachment; filename = WnDelZag.pdf" );
			...
			gif.setAlignment(Image.ALIGN_CENTER);
                        ...
                        UrlopObceM urM = (UrlopObceM)request.getSession().getAttribute("UrlopObceM"); 
        
                        
                        Paragraph p0 = new Paragraph("\n",ffb10);
			
			Paragraph p = new Paragraph(
					"WNIOSEK - DELEGACJA ZAGRANICZNA\n\n", fbold);
			...
			nagtab1.setWidths(wids);
                        ...
                        Paragraph n112 = new Paragraph("     (dział/ośrodek)\n",ffbi);
                        Paragraph n113 = new Paragraph("     (stanowisko)\n",ffbi);
                        
                        Paragraph n11 = new Paragraph("\n\n"+urM.getUrlop().getUzytkownik().getFullname()+"\n",ffb10);
                        n11.add(n111);
                        n11.add("\n\n   "+urM.getUrlop().getUzytkownik().getStruktura().getDzialId().getNazwa().trim()+"\n");
                        n11.add(n112);
                        //n11.add("\n\n\n\n\n...............................................\n");
                        //n11.add(n113);
                        ...
                        String t2 = "\n\nUprzejmie proszę o wyrażenie zgody na delegowanie mnie na wyjazd zagraniczny.\nCel: "+urM.getUrlop().getCel().trim().toUpperCase()+".\nSzkolenie/wyjazd zagraniczny* odbędzie się w terminie od "
                                + df.format(urM.getUrlop().getDataOd())+" do "+df.format(urM.getUrlop().getDataDo())+" w "+urM.getUrlop().getMiejsce().toUpperCase()+".\n\n\n"
                                + "\n\n\n\n\n\n";
                      ...
                      //  Paragraph n24 = new Paragraph(urM.getUrlop().getMiejsce().trim(),ffb10);
                        ...
                        nb2.setBorder(0);
                        nagtab1.addCell(nb2);
                        Paragraph n31 = new Paragraph("(data i podpis Pracownika)\n\n",ffbi);
                        ...
                        String czyZal="NIE";
                        if(urM.getUrlop().isCzyZaliczka())
                            czyZal="TAK";
                        Paragraph n3b = new Paragraph("Zaliczka na wyjazd zagraniczny: "+czyZal+"\n\n",ffb10);
                        
                        PdfPCell nb3b = new PdfPCell(n3b);
                        nb3b.setColspan(2);
                        nb3b.setHorizontalAlignment(Element.ALIGN_LEFT);
                        nb3b.setBorder(0);
                        nb3b.setBorderWidthBottom((float)0.7);
                        nagtab1.addCell(nb3b);
                        
                        if(urM.getUrlop().isCzyZaliczka()){
                            
                            String czyDiety="NIE";
                            if(urM.getUrlop().isCzyDieta())
                                czyDiety="TAK";
                            String czyRycz="NIE";
                            if(urM.getUrlop().isCzyRyczalty())
                                czyRycz="TAK";
                            
                            String t4 = "\n\nZwracam się z prośbą o wypłatę zaliczki w "+urM.getUrlop().getWalutarachunku()+" na wyjazd zagraniczny na pokrycie poniższych kosztów: \n\n"
                                    + " - Diety: "+czyDiety+"\n"
                                    + " - Ryczałt za przejazdy: "+czyRycz+"\n\n"
                                    + " - Hotel (kwota): "+nf.format(urM.getUrlop().getHotel())+"\n"
                                    + " - Inne (kwota): "+nf.format(urM.getUrlop().getInne())+"\n\n"
                                    + "Zaliczkę proszę przelać na poniższy rachunek walutowy, którego jestem właścicielem. \nKonto walutowe: "+urM.getUrlop().getNrrachunku()+" waluta: "+urM.getUrlop().getWalutarachunku()+".\n\n\n";
                        ...
                        String t31=df.format(urM.getUrlop().getDataWprowadzenia())+", "+urM.getUrlop().getUzytkownik().getFullname().trim()+"\n";
                        Paragraph n31b = new Paragraph(t31,ffb10);
                        n31b.add(n31);
                        PdfPCell nb3bb = new PdfPCell(n31b);
                        nb3bb.setColspan(2);
                        nb3bb.setHorizontalAlignment(Element.ALIGN_RIGHT);
                        nb3bb.setBorder(0);
                        nb3bb.setBorderWidthBottom((float)0.7);
                        nagtab1.addCell(nb3bb);
...
//                        nagtab1.addCell(nb5);
//                      
                        Paragraph n6b = new Paragraph("\nWyrażam zgodę na delegowanie pracownika na w/w szkolenie/wyjazd zagraniczny oraz wypłatę zaliczki.\n\n\n\n\n\n\n",ffb10);
                        PdfPCell nb6b = new PdfPCell(n6b);
                        nb6b.setColspan(2);
                        nb6b.setHorizontalAlignment(Element.ALIGN_LEFT);
                        nb6b.setBorder(0);
                        nagtab1.addCell(nb6b);
                        ...
                        String t7 = "(data i podpis Przełożonego)";
