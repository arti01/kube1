...
%><%//
			...
			nagtab1.setWidths(wids);
                       ...
                       //n11.add(n113);
                        ...
                        String infoDod="";
                        if(urM.getUrlop().getInfoDod().trim().length()>0)
                            infoDod=" : "+urM.getUrlop().getInfoDod().trim();
                        String t4 = "\n\nPrzewidywane koszty:\n  - całość: "+nf.format(urM.getUrlop().getKwotaWs().doubleValue())+" zł\n\nW tym:\n"
                                ...
                                + " - inne (jakie): "+nf.format(urM.getUrlop().getInne().doubleValue()) +" zł "+infoDod+"\n\n\n\n";
                        ...
                        if(urM.getUrlop().isZgodnZbudz()){
                            t5 += "zgodne z założonym budżetem szkoleniowym (PL-R-18-03)\n\n"
